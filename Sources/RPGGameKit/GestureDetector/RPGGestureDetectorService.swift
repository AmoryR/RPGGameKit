...
public class RPGGestureDetectorService {
    ...
    public static let shared = RPGGestureDetectorService()
    private init() {}
    
    public func register(_ gestureDetector: RPGGestureDetector, withKey key: String) {
        self.gestureDetectors[key] = gestureDetector
    }
    
    public func removeGestureDetector(withKey key: String) {
        self.gestureDetectors.removeValue(forKey: key)
    }
    
    public func setDefaultGestureDetector(key: String) {
