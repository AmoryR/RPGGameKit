...
public enum RPGUIDAnchor {
    case topLeft, topCenter, topRight
    case bottomLeft, bottomCenter, bottomRight
}

public class RPGHUD: RPGUIElement {
    
    private var gameArea: CGRect?
    public let paddingHorizontal: CGFloat = 15.0
    public let paddingVertical: CGFloat = 5.0
    
    public init(size: CGSize, anchor: RPGUIDAnchor) {
